...
// let arr = [2,5,100];
// let stringItUp = arr.map(function(arr){
//     return arr+=""
// });
...
// let capitalizeNames = arr.map(function(arr){
...
//  arr = [{name: "Angelina Jolie",age: 80 },{name: "Eric Jones",age: 2},{name: "Paris Hilton",age: 5},{name: "Kayne West",age: 16},{name: "Bob Ziroll",age: 100}]

//   let namesOnly= arr.map(function(arr){
//     return arr=arr.name;
...
// console.log(namesOnly)
   ...
   *  ["John", "Jacob", "Jingleheimer", "Schmidt"]
//    */
//   let arr = [{name: "Angelina Jolie",age: 80 },{name: "Eric Jones",age: 2},{name: "Paris Hilton",age: 5},{name: "Kayne West",age: 16},{name: "Bob Ziroll",age: 100}]
...
//case1 
// arr = [1,2,3];
// let doubleValues = arr.map(function(element){
//     return arr=element*2
// });
...
// let extractKey= arr.map(function(arr){
//      return arr.name;
// });
...
// let extractFullName= arr.map(function(arr){
